...
export default function ForgotPasswordPage() {
  ...
  // Only 2 phases: email → reset (OTP + password combined) → success
  ...
  // Step 2: Verify OTP + Reset Password (backend verifies OTP — no free pass!)
  const handleResetPassword = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setError((res as any).message || (res as any).error || 'Invalid OTP or reset failed. Check your code.')
      }
    } catch {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E8F5E9] via-white to-[#FFF3E0] flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="p-8 space-y-5">
          ...
          {/* PHASE 2: OTP + PASSWORD COMBINED (backend verifies OTP before resetting) */}
          {phase === 'reset' && (
            <>
              <div>
